...
class RankController extends Controller
{
    ...
    public function export()
    {
        ...
        $data = ['criteriaweights'=>$criteriaweights, 'alternatives'=>$alternatives, 'scores'=>$scores, 'i'=>0];

        $pdf = PDF::loadview('cetak.rank',$data )
        ->setOptions(['dpi' => 150, 'defaultFont' => 'sans-serif'])
        ->setPaper('a4', 'landscape');
        return $pdf->stream('Data Penerima Bantuan.pdf');
    }
}
